...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">No blood supply. No nerves. No inflammation.</em><br>Only silent, progressive opacity.</div></div></div>
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Nuclear. Cortical. PSC.</em><br>The location tells you the cause. The cause tells you the patient.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()">
  <div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div>
  <div class="n-note-end-cta-arrow">&#8599;</div>
</div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Painful red eye. White corneal spot.</em><br>Same-day referral. No steroids until you know the organism.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()">
  <div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div>
  <div class="n-note-end-cta-arrow">&#8599;</div>
</div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">The retina is brain tissue.</em><br>Every layer has a name, a function, and a disease.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()">
  <div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div>
  <div class="n-note-end-cta-arrow">&#8599;</div>
</div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">DR is asymptomatic until it's devastating.</em><br>Screen every diabetic. Every year.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()">
  <div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div>
  <div class="n-note-end-cta-arrow">&#8599;</div>
</div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">The fundus is a timeline.</em><br>AV nipping = years. Flame haemorrhages = today.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()">
  <div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div>
  <div class="n-note-end-cta-arrow">&#8599;</div>
</div></div>`;
...
<div class="n-section">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:0;border:1px solid rgba(245,242,235,0.1);border-radius:4px;overflow:hidden;">
    <div style="border-right:1px solid rgba(245,242,235,0.08);">
      <div style="font-family:Syne,sans-serif;font-size:10px;font-weight:800;letter-spacing:2px;text-transform:uppercase;padding:14px 18px;border-bottom:1px solid rgba(245,242,235,0.08);color:rgba(245,242,235,0.85);background:rgba(245,242,235,0.04);">Chalazion</div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">What</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Meibomian lipogranuloma — chronic <strong style="color:rgba(245,242,235,0.95);">sterile</strong> inflammation</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Tender?</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;"><strong style="color:rgba(245,242,235,0.95);">No.</strong> Firm nodule in tarsal plate. Non-inflamed.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Cause</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Blocked duct → retained lipid → granulomatous response</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Rx</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Warm compresses → steroid injection → I&amp;C if &gt;4 weeks</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Red flag</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;"><strong style="color:rgba(245,242,235,0.95);">Same site recurrence = biopsy.</strong> Sebaceous carcinoma masquerades here.</span></div>
    </div>
    <div style="">
      <div style="font-family:Syne,sans-serif;font-size:10px;font-weight:800;letter-spacing:2px;text-transform:uppercase;padding:14px 18px;border-bottom:1px solid rgba(245,242,235,0.08);color:#c8452a;background:rgba(200,69,42,0.07);">Hordeolum (Stye)</div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">What</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Staphylococcal abscess — acute <strong style="color:rgba(245,242,235,0.95);">bacterial</strong> infection</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Tender?</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;"><strong style="color:rgba(245,242,235,0.95);">Yes.</strong> Acutely painful, red, pointing. Hot lid.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Cause</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Staph aureus. External = Zeis/Moll. Internal = Meibomian.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Rx</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Warm compresses + topical abx. Systemic if cellulitis.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Red flag</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;"><strong style="color:rgba(245,242,235,0.95);">Fever + proptosis + restricted EOM</strong> = orbital cellulitis. IV abx now.</span></div>
    </div>
  </div>
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">The pupil localises the cause of ptosis.</em><br>Dilated = aneurysm. Miosis = Horner. Normal = myasthenia or aponeurotic.<br>Tender lid lump = infected. Same-site recurrence = biopsy.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Watery eye ≠ too many tears.</em><br>Three layers, three failure modes. Drainage has anatomy — obstruction has surgery.<br>Sjögren = screen for lymphoma.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-section">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:0;border:1px solid rgba(245,242,235,0.1);border-radius:4px;overflow:hidden;">
    <div style="border-right:1px solid rgba(245,242,235,0.08);">
      <div style="font-family:Syne,sans-serif;font-size:10px;font-weight:800;letter-spacing:2px;text-transform:uppercase;padding:14px 18px;border-bottom:1px solid rgba(245,242,235,0.08);color:rgba(245,242,235,0.85);background:rgba(245,242,235,0.04);">Episcleritis</div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Pain</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Mild discomfort or <strong style="color:rgba(245,242,235,0.95);">none.</strong> Dull ache at most.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Colour</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Bright red, sectoral. <strong style="color:rgba(245,242,235,0.95);">Blanches with phenylephrine.</strong></span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">VA</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;"><strong style="color:rgba(245,242,235,0.95);">Normal.</strong> No threat to vision.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Systemic</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Usually idiopathic. Mild assoc: IBD, RA.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Rx</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Topical NSAIDs or lubricants. Self-limiting weeks.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Urgency</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Routine — no emergency referral needed.</span></div>
    </div>
    <div style="">
      <div style="font-family:Syne,sans-serif;font-size:10px;font-weight:800;letter-spacing:2px;text-transform:uppercase;padding:14px 18px;border-bottom:1px solid rgba(245,242,235,0.08);color:#c8452a;background:rgba(200,69,42,0.07);">Scleritis</div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Pain</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;"><strong style="color:rgba(245,242,235,0.95);">Severe boring pain. Wakes from sleep.</strong> Radiates jaw/temple.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Colour</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Deep violaceous. <strong style="color:rgba(245,242,235,0.95);">Does NOT blanch</strong> with phenylephrine.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">VA</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Can be <strong style="color:rgba(245,242,235,0.95);">reduced.</strong> Posterior → exudative RD.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Systemic</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;"><strong style="color:rgba(245,242,235,0.95);">RA · GPA · SLE · IBD</strong> — full workup mandatory.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;border-bottom:1px solid rgba(245,242,235,0.06);"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Rx</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;">Oral NSAIDs → steroids → DMARDs. Topicals insufficient.</span></div>
      <div style="display:grid;grid-template-columns:82px 1fr;"><span style="font-family:Syne,sans-serif;font-size:7.5px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(245,242,235,0.3);padding:11px 8px 11px 18px;border-right:1px solid rgba(245,242,235,0.06);display:flex;align-items:center;">Urgency</span><span style="font-family:JetBrains Mono,monospace;font-size:11px;color:rgba(245,242,235,0.78);padding:11px 16px;line-height:1.5;"><strong style="color:rgba(245,242,235,0.95);">Urgent.</strong> Scleral thinning → perforation if untreated.</span></div>
    </div>
  </div>
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Red eye safety screen: VA + pupil + photophobia before discharge.</em><br>Pre-auricular node = viral. Hyperacute purulent = gonococcal emergency.<br>Blanches with phenylephrine = episcleritis. Does not blanch = scleritis.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">KP type predicts aetiology. Mutton-fat = granulomatous = systemic search.</em><br>HLA-B27: unilateral, acute, recurrent. Dilate early to prevent synechiae.<br>Always exclude syphilis. Always exclude infection before steroids.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Fixed. Mid-dilated. Oval. Red eye. Vomiting.</em><br>Not migraine. Acute angle-closure. Every minute matters.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Myopia: long eye, concave lens. Hyperopia: short eye, convex lens.</em><br>High myopia = annual fundus check. Hyperopia in children = squint screen.<br>LASIK reshapes cornea — it cannot fix the lens.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Flashes. Floaters. Curtain. Tobacco dust.</em><br>Same-day exam. Macula-on = same-day surgery. No exceptions.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Cherry red spot. Thunderstorm fundus. Curtain descending.</em><br>Every vascular occlusion needs an embolic source search today.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Pain on eye movement. Proptosis. VA loss.</em><br>Not preseptal. Orbital cellulitis until proven otherwise.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Colour desaturation. RAPD. Pain on movement.</em><br>In the elderly: exclude GCA before anything else.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Leukocoria in a child = retinoblastoma until proven otherwise. Never biopsy.</em><br>Uveal melanoma → liver surveillance. Choroidal mets > primary melanoma in frequency.<br>Madarosis + lid lesion = malignancy. Recurrent chalazion = biopsy.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Eye drops have systemic effects — always take a drop history.</em><br>Prostaglandins first-line. Timolol CI: asthma. Brimonidine CI: infants.<br>Never steroids for undiagnosed red eye. GCA: treat before biopsy.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Distortion means wet. Wet means urgent.</em><br>Anti-VEGF preserves vision. But only if started before the scar forms.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:#1a1410;border-left:3px solid rgba(200,69,42,0.7);border-radius:4px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.1px;font-weight:400;display:block;"><em style="color:rgba(15,10,8,0.95);font-style:italic;">Where is the redness? What is the pupil doing? Is the vision affected?</em><br>Three questions. They give you the diagnosis.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
