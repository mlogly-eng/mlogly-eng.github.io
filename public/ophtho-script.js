...
(function(){
  ...
  s.textContent=`.n-anchor{margin:0;padding:0 32px;}.n-anchor-card{background:linear-gradient(150deg,rgba(200,69,42,0.08) 0%,rgba(180,100,40,0.04) 60%,rgba(200,69,42,0.06) 100%);border:1px solid rgba(200,69,42,0.18);border-left:3px solid rgba(200,69,42,0.45);border-radius:6px;padding:32px 40px 30px 34px;margin:0;position:relative;}.n-anchor-card::before{content:'';position:absolute;top:0;left:0;right:0;height:1px;background:linear-gradient(90deg,rgba(200,69,42,0.45),rgba(200,69,42,0.12),transparent);border-radius:6px 6px 0 0;}.n-anchor-label{font-family:Syne,sans-serif;font-size:8.5px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.6);text-transform:uppercase;display:block;margin-bottom:16px;}.n-anchor-text{font-family:'Instrument Serif',Georgia,serif;font-size:clamp(17px,2vw,24px);line-height:1.65;color:rgba(245,242,235,0.88);letter-spacing:0.15px;font-weight:400;display:block;}.n-anchor-text em{font-style:italic;color:rgba(245,242,235,0.98);}.n-anchor-ornament{display:none;}`;
