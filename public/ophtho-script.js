...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Nuclear. Cortical. PSC.</em><br>The location tells you the cause. The cause tells you the patient.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()">
  <div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div>
  <div class="n-note-end-cta-arrow">&#8599;</div>
</div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Painful red eye. White corneal spot.</em><br>Same-day referral. No steroids until you know the organism.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()">
  <div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div>
  <div class="n-note-end-cta-arrow">&#8599;</div>
</div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>DR is asymptomatic until it's devastating.</em><br>Screen every diabetic. Every year.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()">
  <div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div>
  <div class="n-note-end-cta-arrow">&#8599;</div>
</div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Red eye safety screen: VA + pupil + photophobia before discharge.</em><br>Pre-auricular node = viral. Hyperacute purulent = gonococcal emergency.<br>Blanches with phenylephrine = episcleritis. Does not blanch = scleritis.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>KP type predicts aetiology. Mutton-fat = granulomatous = systemic search.</em><br>HLA-B27: unilateral, acute, recurrent. Dilate early to prevent synechiae.<br>Always exclude syphilis. Always exclude infection before steroids.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Fixed. Mid-dilated. Oval. Red eye. Vomiting.</em><br>Not migraine. Acute angle-closure. Every minute matters.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Myopia: long eye, concave lens. Hyperopia: short eye, convex lens.</em><br>High myopia = annual fundus check. Hyperopia in children = squint screen.<br>LASIK reshapes cornea — it cannot fix the lens.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Flashes. Floaters. Curtain. Tobacco dust.</em><br>Same-day exam. Macula-on = same-day surgery. No exceptions.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Cherry red spot. Thunderstorm fundus. Curtain descending.</em><br>Every vascular occlusion needs an embolic source search today.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Colour desaturation. RAPD. Pain on movement.</em><br>In the elderly: exclude GCA before anything else.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Eye drops have systemic effects — always take a drop history.</em><br>Prostaglandins first-line. Timolol CI: asthma. Brimonidine CI: infants.<br>Never steroids for undiagnosed red eye. GCA: treat before biopsy.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Distortion means wet. Wet means urgent.</em><br>Anti-VEGF preserves vision. But only if started before the scar forms.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor" style="margin:0;padding:0 32px;border-top:none!important;"><div style="background:rgba(200,69,42,0.06);border-left:3px solid rgba(200,69,42,0.5);border-radius:6px;padding:28px 36px 28px 32px;position:relative;"><span style="font-family:Syne,sans-serif;font-size:8px;font-weight:700;letter-spacing:3.5px;color:rgba(200,69,42,0.65);text-transform:uppercase;display:block;margin-bottom:14px;">THE ONE THING TO REMEMBER</span><div style="font-family:'Instrument Serif',Georgia,serif;font-size:clamp(16px,1.9vw,22px);line-height:1.65;color:rgba(15,10,8,0.82);letter-spacing:0.1px;font-weight:400;display:block;"><em>Where is the redness? What is the pupil doing? Is the vision affected?</em><br>Three questions. They give you the diagnosis.</div></div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
