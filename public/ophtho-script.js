...
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div>`;
...
<div class="n-anchor"><div class="n-anchor-text"><em>Distortion means wet. Wet means urgent.</em><br>Anti-VEGF preserves vision. But only if started before the scar forms.</div></div>
...
<div class="n-anchor"><div class="n-anchor-text"><em>Where is the redness? What is the pupil doing? Is the vision affected?</em><br>Three questions. They give you the diagnosis.</div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
...
<div class="n-anchor"><div class="n-anchor-text"><em>The brain suppresses what it cannot fuse. And after age eight, that suppression is permanent.</em><br>Detect early. Patch early. The window closes.</div></div>
<div class="n-note-end-cta" onclick="showVentPopup()"><div><div class="n-note-end-cta-tag">// End of note</div><div class="n-note-end-cta-title">Are you ventilating?</div><div class="n-note-end-cta-sub">5 questions. No feedback until the end.</div></div><div class="n-note-end-cta-arrow">&#8599;</div></div></div>`;
