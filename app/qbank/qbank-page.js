      ...
      <div id="screen-launcher">
        <div className="launcher">
          ...
          <div className="focus-banner" id="focus-banner" style={{display:'none'}}>
            ...
            <button className="focus-banner-close" onClick={() => window.dismissFocusBanner && window.dismissFocusBanner()}>x</button>
          </div>
      ...
      <div id="screen-session">
        <div className="mobile-progress" id="mobile-progress">
          <div className="mob-prog-bar">
            <div className="mob-prog-fill" id="mob-prog-fill" style={{width:'0%'}}></div>
          </div>
          <span className="mob-prog-txt" id="mob-prog-txt">Q1 / </span>
          <span className="mob-prog-mode" id="mob-prog-mode">Normal</span>
          <button
            style={{background:'none', border:'none', fontSize:'10px', color:'var(--ink4)', cursor:'pointer', padding:'0 0 0 8px'}}
            onClick={() => window.exitSession && window.exitSession()}
          >x</button>
        </div>
        <div className="session">
          <div className="sidebar" id="sidebar">
            ...
            <div className="sb-bar">
              <div className="sb-bar-fill" id="sb-bar-fill" style={{width:'0%'}}></div>
            </div>
            <div className="sb-q-list" id="sb-q-list"></div>
            <div className="sb-footer">
              <button className="sb-flag-btn" id="sb-flag-btn" onClick={() => window.toggleFlag && window.toggleFlag()} title="Flag">flag</button>
              <button className="sb-exit" onClick={() => window.exitSession && window.exitSession()} title="Exit">x</button>
            </div>
